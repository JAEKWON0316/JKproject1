...
let c = a.substring(a.length-1,a.length);
  return (c + a.substring(1,a.length-1) + b);  //return을 해줄 때는 함수 밖에서 콘솔로 찍어줘야한다 리턴값을
}
...
str("swift");  //함수안에 콘솔로그가 있을 땐 그냥 함수에 매개변수만 넣어줘도 된다.
...
// 5. 임의의 수 x, y가 모두 50~99사이에 있는지 확인하라.
function check2(x,y){
